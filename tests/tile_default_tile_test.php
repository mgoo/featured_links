 ...
 */
class block_featured_links_tile_default_tile_testcase extends test_helper {
    ...
    public function test_tile_custom_save() {
        ...
        $tile_real = new \block_featured_links\tile\default_tile($DB->get_record('block_featured_links_tiles', ['id' => $tile1->id]));
    ...
    public function test_tile_render_background() {
        ...
        $file_url = $CFG->dirroot.'/blocks/featured_links/tests/fixtures/test.png';
        $fs = get_file_storage();
        $file_record = ['contextid' => $context->__get('id'),
            'component' => 'block_featured_links',
    ...
    public function test_render_content() {
        ...
        $this->assertContains('block-featured-links-content-top', $content);
    }
}