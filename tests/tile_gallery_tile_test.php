...
/**
 * Class block_featured_links_tile_gallery_tile_testcase
 * Test the gallery_tile class
 */
class block_featured_links_tile_gallery_tile_testcase extends test_helper {
    /**
    ...
    public function test_tile_custom_save() {
        ...
        $data = new \stdClass();
        $data->type = 'block_featured_links-gallery_tile';
        $data->sortorder = 4;
        ...
        $tile_real = new \block_featured_links\tile\gallery_tile($DB->get_record('block_featured_links_tiles', ['id' => $tile1->id]));
