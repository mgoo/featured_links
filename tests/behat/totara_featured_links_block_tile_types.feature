...
Feature: Test that the tile types other than the default tile work as expected
  ...
  Scenario: Test the label top tile
    ...
    #And I upload "blocks/featured_links/tests/fixtures/Desert.jpg" file to "Background Image" filemanager  # There doenst seem to be a way of testing fileuploads in a totara form
    #And I set the "background_img" Totara form field to "blocks/featured_links/tests/fixtures/Desert.jpg"  # As neither of these work.
    And I click on "Save changes" "button"
    Then I should see "default description"
    And ".block-featured-links-content-top" "css_element" should exist
  ...
  Scenario: Test the multi image tile
    ...
    And I click on "Save changes" "button"
    Then I should see "default description"
    And ".block-featured-links-gallery-images" "css_element" should exist
