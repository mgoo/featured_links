...
/**
 * Class block_featured_links_tile_base_children_test
 * This tests all the children of the base class to see if there are any general errors in the way that they work.
 */
class block_featured_links_tile_base_all_tiles_testcase extends test_helper {
    /**
    ...
    public function test_get_visibility_form() {
        ...
        foreach ($this->tile_types as $tile_type) {
            ...
            $this->assertInstanceOf('\block_featured_links\tile\base_form_visibility', $edit_form);
        }
    }
