...
// License: MIT
define(['jquery', 'core/str'], function($, mdlstr){
    "use strict";
    ...
    var defaultOpts = {
        ...
        cancelText: "",
        chooseText: "",
        togglePaletteMoreText: "", // These are not used in this application of spectrum.
        togglePaletteLessText: "",
        clearText: "",
        noColorSelectedText: "", // Not used so doesnt need a string
    ...
    function spectrum(element, o) {
        ...
        function initialize() {
            ...
            mdlstr.get_strings([{key: 'cancel', component: 'moodle'},{key: 'choose', component: 'moodle'}]).done(function(string_results){
                cancelButton.text(string_results[0]);
                chooseButton.text(string_results[1]);
            });
