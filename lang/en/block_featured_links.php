...
$string['access_custom'] = 'Apply rules';
$string['access_hide'] = 'Hidden from all';
$string['access_label'] = 'Access';
$string['access_show'] = 'Visible to all';
...
$string['audience_hide'] = 'You do not have permission to edit the audience\'s on this tile. Please contact the system administrator if you wish to do so. number of visible audiences: @@#@@';
$string['audience_showing'] = 'Define access by audience rules';
$string['audience_title'] = 'Audience';
$string['auth_edit'] = 'Edit Visibility';
$string['block_header'] = 'Title For the Block';
$string['blockstring'] = 'This is the blockstring String';
$string['cardheader'] = 'heading for the card';
...
$string['default_name'] = 'Default Tile';
$string['hidden_text'] = 'Hidden';
$string['invalid_class'] = 'This value does not point to a valid class tile type';
$string['invalid_class_name'] = 'The value is not a valid class name';
$string['less'] = 'less';
