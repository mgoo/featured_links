...
$string['audience_hide'] = 'You do not have permission to edit the audience\'s on this tile. Please contact the system administrator if you wish to do so. number of visible audiences: {$a}';
...
$string['clear_color']  = 'Clear Color Selection';
$string['confirm'] = 'Are you sure you want to delete this tile?';
$string['content_edit'] = 'Edit Content';
$string['content_menu_title'] = 'Content<span class="sr-only">Edit content for {$a} tile</span>';
...
$string['default_name'] = 'Static Tile';
$string['delete_audience_rule'] = 'Delete audience {$a} from block';
$string['delete_menu_title'] = 'Delete<span class="sr-only">Delete the {$a} tile</span>';
...
$string['interval_help'] = 'The time in seconds between the background image switching';
...
$string['manual_id_help'] = 'An id that is applied to the block. To be used by themes';
$string['multi_name'] = 'Gallery Tile';
...
$string['tile_background'] = 'Background image';
$string['tile_background_color'] = 'Background color';
$string['tile_background_help'] = 'The images displayed will be square so it is recommended that you upload a square image. Accepted image types are .jpg, .png, .gif, .bmp, .svg and .cgm';
$string['tile_description'] = 'Description';
$string['tile_gallery_background'] = 'Background images';
$string['tile_gallery_background_help'] = 'If multiple images are selected, the background image will switch between the available images at random, at an interval specified by the Interval setting.';
...
$string['visibility_menu_title'] = 'Visibility<span class="sr-only">Edit visibility for the {$a} tile</span>';
