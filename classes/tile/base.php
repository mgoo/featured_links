            ...
            'controls' => $renderer->render(
                new \action_menu([
                    new \action_menu_link_secondary(
                        ...
                        get_string('content_menu_title','block_totara_featured_links', $this->get_accessibility_text()['sr-only']),
                        ['type' => 'edit']),
                    new \action_menu_link_secondary(
                        new \moodle_url('/blocks/totara_featured_links/edit_tile_visibility.php',
                            ['blockinstanceid' => $this->blockid, 'tileid' => $this->id, 'return_url' => $PAGE->url->out_as_local_url()]),
                        new flex_icon('hide', ['class' => 'iconsmall', 'title' => '']),
                        get_string('visibility_menu_title','block_totara_featured_links', $this->get_accessibility_text()['sr-only']),
                        ['type' => 'edit_vis']),
                    new \action_menu_link_secondary(
                        new \moodle_url('/'),
                        new flex_icon('delete', ['class' => 'iconsmall', 'title' => '']),
                        get_string('delete_menu_title','block_totara_featured_links', $this->get_accessibility_text()['sr-only']),
